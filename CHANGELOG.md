...
HEAD        Tue Mar 17 12:47:55 2026 -0400               0 commits

2.12.15        Tue Mar 17 12:48:29 2026 -0400              18 commits

  Mareike Janiak <mareike.janiak@computationalgenomics.ca>            15 commits

       068fa2a Version bump to 2.12.15
       7053716 change elif order to look for bai or crai first
       fb3477a debug
       dc5864f check for extension string only at end of file name
       d4b1c48 parse one input file for two report sections
       0b3decf debug parsing for revio index and qc metrics
       71e28d9 pass revio coverage as number, not string
       f489607 abandon custom collapse annotation script, not meant to run with UCSC annotations
       fbc17f1 adding modified collapse_annotation script to accommodate UCSC annotation files
       a4cf4a5 clean up debugging
       a194553 clean up debugging
       2da03d9 debug somalier parsing
       dc1ceb6 add mean and median read length fields for illumina runs
       17f1944 add changes to deseq2.R from Senthil, fixes deseq output parsing
       72adba8 adjust parsing for somalier to account for biosample id

  mareike.janiak@computationalgenomics.ca <mareike.janiak@computationalgenomics.ca>             1 commits

       7c4aa75 Version bump to 2.12.14

  MareikeJaniak <30602072+MareikeJaniak@users.noreply.github.com>             1 commits

       412e564 Merge pull request #5 from c3g/dev_2.12.15

  MareikeJaniak <mareike.janiak@gmail.com>             1 commits

       ec6a40e python-tools/runProcessingMetricsToJson.py
